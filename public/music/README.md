...
| **Volume**     | Master to roughly **-12 LUFS** (or peak around -3 dBFS). The game plays it at 35% gain by default, so a quieter master leaves headroom — louder masters force users to reach for the mute toggle. |
